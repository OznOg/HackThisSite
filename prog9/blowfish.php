...
function sbox_round($integer)
    ...
    // seb's comment: the original 2^32 was replaced by 4294967295 here, I
    // guess for the 32bits machines problem exposed in the forum
    $return = ($sbox0[$b0] + $sbox1[$b1] % 4294967295) ;
    $return = ($return ^ $sbox2[$b2]) + $sbox3[$b3] % 4294967295;
